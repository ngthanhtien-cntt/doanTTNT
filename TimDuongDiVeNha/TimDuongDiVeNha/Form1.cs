...
namespace TimDuongDiVeNha
{
    public partial class Form1 : Form
    {
        ...
        // khởi tạo và hiển thị quá trình tìm đường trên bàn cờ.
        ...
        //gọi khi cần vẽ lại bàn cờ. Trong phương thức này, các ô cờ được vẽ lại.
        ...
        //xử lý sự kiện khi chuột được nhấn xuống trên bàn cờ.
        //Trong phương thức này, xác định vị trí của chuột trên bàn cờ và xử lý các sự kiện tương ứng.
        private void BanCo_MouseDown(object sender, MouseEventArgs e)
        {
            Color StartColor = Color.Red;
            Color EndColor = Color.DarkOrange;
            int Dong = e.Y / Cao; int Cot = e.X / Rong; //tính toán vị trí dòng và cột trên bàn cờ dựa trên tọa độ chuột.
            ...
            {
                //kiểm tra vị trí chuột để xử lý việc di chuyển vật thể.
                MouseDowning = true;
                //Nếu vị trí chuột trùng với điểm bắt đầu hoặc đã được kích hoạt di chuyển vật thể (MovePosObject)
            ...
            //Nếu không phải là chuột trái hoặc chuột phải, thoát khỏi phương thức.
            else
                return;
            ...
            //nếu SetObject_Clicked=true và không kích hoạt sự kiện xóa một vật cản DelOne = false
            //thực hiện đặt vật cản tại vị trí chuột.Những vật cản được đặt tại các ô trên bàn cờ.
        ...
        {
            // nếu các vật đang di chuyển và người dùng đặt thêm vật cản thì cập nhật lại đường đi
            if (ObjectMoving && MouseDowning && (SetObject_Clicked || DelOne)) 
            {
                main.KhoiTaoToaDo(MauBanCo);
            ...
            while (true)
            {
                ...
                else
                {
                    if (main.ToaDo[Row, Column] == StartPos)
                    {
                        ...
                        {
                            Invoke(new Action(() => LamMoi.Enabled = AStart.Enabled = true)); // gọi hàm dẫn control
        ...
        private void Moving_Click(object sender, EventArgs e)
        {
            ...
            LamMoi.Enabled = AStart.Enabled = false; // tắt các thành phần không được sử dụng trong khi vật thể chuyển động        
            ObjectMoving = true;
